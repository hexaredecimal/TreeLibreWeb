export type WebswingApiRegister = {
    api: {
...
export interface IWebswingInstance {
    ...
    disconnect: () => void;
    /**
     * Destroys this Webswing instance so that it cannot start again.
     */
    destroy: () => void;
    /**
    ...
    /**
     * Find a web component by its id.
     */
    getWebComponentById: (wcId: string) => IInternalWindow | undefined;
    /**
     * Perform an action that triggers server-side listener.
     */
    performAction: (options: IWebActionEvent) => void;
    /**
     * Call an action that triggers server-side listener and returns a Promise which resolves when the server-side action returns.
     */
    callAction: (options: IWebActionEvent) => Promise<IWebActionEvent>;
    /**
...
export interface IExternalFileManager {
    uploadFile: (file: WebswingFile) => void;
...
export type BootstrapOptions = {
    ...
    fetchTimeout?: number;
    disposeCanvasOnDisconnect?: boolean;
    disableLogout?: boolean;
    syncClipboard?: boolean;
    debugLog?: boolean;
    traceLog?: boolean;
    javaCallTimeout?: number;
    useWindowTop?: boolean;
    hideTouchBar?: boolean;
    disableAppDocumentTitle?: boolean;
    accessibilityDisabledByOverride?: boolean;
    multiScreenSupportEnabled?: boolean;
    taskbarEnabled?: boolean;
    taskbarAutoHide?: boolean;
    taskbarSnap?: boolean;
    audioBeepSrc?: string;
    audioPlaybackPingPeriod?: number;
    canvasResizeCheckPeriod?: number;
    undockCanvasResizePeriod?: number;
    undockCheckPeriod?: number;
    undockPendingEventExpiration?: number;
    touchToastPeriod?: number;
    touchTapDelayThreshold?: number;
    touchDoubleTapDelayThreshold?: number;
    touchTapMoveThreshold?: number;
    touchLongPressStartTimeoutPeriod?: number;
    touchScaleHidePeriod?: number;
    touchScaling?: boolean;
    touchStaticScale?: boolean;
    touchStaticScaleWidth?: number;
    touchStaticScaleHeight?: number;
    touchSwipeScroll?: boolean;
    touchModeAutoSwitch?: boolean;
    findHiddenWindowsPeriod?: number;
    findHiddenWindowsThreshold?: number;
    tabHeartbeatPeriod?: number;
    tabHeartbeatThreshold?: number;
    tabHeartbeatCleanupThreshold?: number;
    tabHeartbeatCleanupPeriod?: number;
    requestComponentTreeWaitTime?: number;
    continueOldSessionDialogDismissPeriod?: number;
    servletHeartbeatPeriod?: number;
    sessionTimeoutWarningDialogDismissPeriod?: number;
    applicationBusyDialogDismissPeriod?: number;
    hideDropTargetsPeriod?: number;
    directUploadChunkSize?: number;
    directDownloadCleanupInterval?: number;
    directDownloadCleanupExpiration?: number;
    killWhenPopupBlocked?: boolean;
    preventWheelEvent?: boolean;
    inputSendPeriod?: number;
    pingCount?: number;
    pingInterval?: number;
    pingMaxLatency?: number;
    pingNotifyIf?: number;
    pingUrl?: string;
    requestTabCloseTimeout?: number;
    uploadDirectories?: boolean;
};
export type WebswingOptions = BootstrapOptions & {
    connectionUrl?: string;
    undockConnectionUrl?: string;
    ...
    linkedViewId?: string;
    linkedViewName?: string;
    mirrorConnectionUrl?: string;
    mirrorTokenCallback?: () => Promise<string>;
    mirrorSuffixCallback?: () => Promise<string>;
    mirrorMode?: boolean;
    testMode?: boolean;
    recording?: boolean;
    ...
    filesListener?: {
        directTransferDownloadProgressAll(downloadsCount: number, loadedAll: number, totalAll: number): void;
        directTransferDownloadAllDone(): void;
        directTransferDownloadDone(fileName: string, downloadsCount?: number): void;
        directTransferDownloadFailed(reason: string, fileName: string): void;
        fileUploadProgressAll(loadedAll: number, totalAll: number): void;
        fileUploadDone(fileName: string): void;
        fileUploadFailed(isAbort: boolean, fileNames: string[], responseText?: string): void;
        handleError(msg: string): void;
    };
    actions?: {
        [key: string]: (event: IWebActionEvent) => void | String | Uint8Array | Promise<string | Uint8Array | void>;
    } | null;
};
export type IHtmlWindow = IInternalWindow;
export type HtmlOrCanvasWindow = IHtmlWindow | ICanvasWindow;
export type WebswingWindow = HtmlOrCanvasWindow;
export interface ICanvasWindow {
    ...
    dockMode: number;
    dockType: number;
    dockState: number | null | undefined;
    ...
    getDockMode: () => number;
    getDockType: () => number;
    getDockState: () => number | null | undefined;
    renderHere: () => void;
    ...
    callAction: (options: IWebActionEvent) => Promise<IWebActionEvent>;
    handleActionCall: (event: IWebActionEvent) => void | String | Uint8Array | Promise<string | Uint8Array | void>;
...
export interface IDialogs {
    ...
    connectedWaitingDialog: IDialogContent | null;
    ...
    configurationError: IDialogContent | null;
    ...
    timedoutDisconnectedDialog: IDialogContent | null;
    ...
    startupErrorDialog: IDialogContent | null;
    linkedViewFailedDialog: IDialogContent | null;
    cookiesErrorNotification: IDialogContent | null;
}
export interface IDialogContent {
    header?: string;
    content: string;
    buttons?: Array<IDialogButton | (() => IDialogButton | false)> | null | undefined;
    events?: {
...
export interface IWebActionEvent {
    actionName?: string;
    data?: string;
    binaryData?: Uint8Array;
    windowId?: string;
}
export interface WebswingFile extends File {
    relativePath?: string;
}
